...
): err is { code?: SyncResult['errorCode']; errorCode?: SyncResult['errorCode'] } =>
  typeof err === 'object' &&
  err !== null &&
  (('code' in err && (err as { code?: string }).code === code) ||
    ('errorCode' in err && (err as { errorCode?: string }).errorCode === code))
